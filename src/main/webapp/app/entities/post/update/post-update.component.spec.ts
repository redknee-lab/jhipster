...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 5802 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 3739 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 15328 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 27774 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 25258 };
      post.blog = blog;
      const tag: ITag = { id: 6725 };
      post.tags = [tag];
